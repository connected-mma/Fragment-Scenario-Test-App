...
import com.example.fragmentscenarioexperiment.di.support.DaggerPreferenceFragmentx
...
/**
 * A subclass of [DaggerPreferenceFragmentx] which uses the [PelotonSavedStateViewModelFactory]
 *
 ...
 */
abstract class DaggerViewModelPreferenceFragment : DaggerPreferenceFragmentx() {
